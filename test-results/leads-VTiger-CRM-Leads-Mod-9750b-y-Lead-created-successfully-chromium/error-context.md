...
- Name: leads.spec.js >> VTiger CRM Leads Module Tests >> Verify Lead created successfully
- Location: tests\leads.spec.js:35:3
...
Call log:
  - waiting for locator('input[name="user_password"]')
